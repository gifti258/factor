...
ALIAS: unuse: UNUSE:
ALIAS: using: USING:
ALIAS: qualified: QUALIFIED:
ALIAS: qualified-with: QUALIFIED-WITH:
ALIAS: from: FROM:
...
ALIAS: w{ W{
ALIAS: hs{ HS{
ALIAS: postpone: POSTPONE:
ALIAS: m\ M\
ALIAS: syntax: SYNTAX:
ALIAS: symbol: SYMBOL:
ALIAS: symbols: SYMBOLS:
ALIAS: initialized-symbol: INITIALIZED-SYMBOL:
ALIAS: singletons: SINGLETONS:
ALIAS: defer: DEFER:
ALIAS: alias: ALIAS:
...
ALIAS: m: M:
ALIAS: union: UNION:
ALIAS: intersection: INTERSECTION:
ALIAS: mixin: MIXIN:
ALIAS: instance: INSTANCE:
ALIAS: predicate: PREDICATE:
...
ALIAS: macro: MACRO:
ALIAS: memo: MEMO:
ALIAS: identity-memo: IDENTITY-MEMO:
ALIAS: m:: M::
ALIAS: macro:: MACRO::
ALIAS: memo:: MEMO::
ALIAS: identity-memo:: IDENTITY-MEMO::
